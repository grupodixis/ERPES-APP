# Descuentos — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Descuentos aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de Descuentos
- [ ] Tipo `Porcentaje/Importe` + validaciones.
