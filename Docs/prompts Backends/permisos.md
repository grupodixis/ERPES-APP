# Permisos — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Permisos aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
