...
Table Clientes {
  ...
  VendedorId int [ref: > Personas.IdPersona, null]
...
Table LineasDeParte {
  ...
  indexes { (IdParte) (IdOrden) (IdTrabajo) (IdPlanificacion) }
}
...
Table LineasCertificacion {
  ...
  IdObra int [ref: > Obras.IdObra]
  indexes { (IdCertificacion, IdPartida) [unique] }
}
...
Ref: "Presupuestos"."IdCliente" < "Partidas"."Largo"