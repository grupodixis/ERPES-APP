# TiposCambio — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar TiposCambio aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de TiposCambio
- [ ] `(IdMoneda, Fecha) UNIQUE`.
- [ ] `Tasa > 0`.
...
- `GET/POST /tipos-cambio`
- `GET/PATCH/DELETE /tipos-cambio/{id}`
- `GET /tipos-cambio/moneda/{idMoneda}?from=YYYY-MM-DD&to=YYYY-MM-DD`
