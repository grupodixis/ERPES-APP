# Facturas — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Facturas aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de Facturas
- [ ] Impuestos por línea/documento.
...
- `CRUD /facturas`
- `GET/POST /facturas/{id}/lineas`
- `GET /facturas/{id}/impuestos`
- `POST /facturas/{id}/generar-vencimientos`
