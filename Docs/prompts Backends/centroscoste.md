# CentrosCoste — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar CentrosCoste aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de CentrosCoste
- [ ] Jerarquía `IdCentroPadre` (árbol/breadcrumbs).
