# Productos — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Productos aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de Productos
- [ ] `(IdEmpresa, CodigoSKU) UNIQUE`.
- [ ] `IdUMVenta`, `IdTipoIVA`.
- [ ] Clonación para variantes.

---

## 2) Endpoints propuestos
- `CRUD /productos`
- `POST /productos/{id}/clonar`
- `GET /productos/{id}/bom`
