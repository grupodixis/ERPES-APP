# UsuariosRoles — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar UsuariosRoles aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de UsuariosRoles
- [ ] Alta/baja de asignaciones usuario↔rol.

---

## 2) Endpoints propuestos
- `GET /usuarios/{id}/roles`
- `POST /usuarios/{id}/roles/{idRol}`
- `DELETE /usuarios/{id}/roles/{idRol}`
