# TiposIVA — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar TiposIVA aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
