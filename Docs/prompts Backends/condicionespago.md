# CondicionesPago — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar CondicionesPago aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de CondicionesPago
- [ ] Generador de vencimientos (días, día fijo, fin de mes).

---

## 2) Endpoints propuestos
- `CRUD /condiciones-pago`
- `POST /condiciones-pago/{id}/simular?importe=...&fecha=...`
