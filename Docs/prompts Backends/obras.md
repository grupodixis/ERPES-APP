# Obras — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Obras aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de Obras
- [ ] `EsProvisional` con **promoción** a definitiva (Series).
- [ ] Bloqueo de OT/Albarán/Factura si provisional.

---

## 2) Endpoints propuestos
- `CRUD /obras`
- `POST /obras/{id}/promover`
- `GET /obras/{id}/documentos`
