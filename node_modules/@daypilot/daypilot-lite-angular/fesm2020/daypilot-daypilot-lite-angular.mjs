...
if (function () {
    function e(e) { var t = DayPilot.Date.Cache.Ticks; if (t[e])
        ...
        throw "The minimum year supported is 1."; c < 10 ? c = "000" + c : c < 100 ? c = "00" + c : c < 1e3 && (c = "0" + c); var u = c + "-" + d + "-" + l + "T" + s + ":" + r + ":" + o + n; return t[e] = u, u; }
    ...
    if ("undefined" == typeof DayPilot.$) {
        "undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), DayPilot.$ = function (e) { return document.getElementById(e); }, Object.defineProperty(DayPilot, "isKhtml", { get: function () { return "undefined" != typeof navigator && navigator.userAgent && navigator.userAgent.indexOf("KHTML") !== -1; } }), DayPilot.touch = {}, DayPilot.touch.start = "touchstart", DayPilot.touch.move = "touchmove", DayPilot.touch.end = "touchend", DayPilot.mo2 = function (e, t) { if ("undefined" != typeof t.offsetX) {
        ...
        } }, DayPilot.Util.copyProps = function (e, t, n) { if (t || (t = {}), !e)
            ...
            } return t; }, DayPilot.Util.atLeast = function (e, t) { return Math.max(e, t); }, DayPilot.Util.mouseButton = function (e) { var t = {}; switch (e.button) {
            case 0:
                t.left = !0;
                break;
            case 1:
        ...
        DayPilot.Areas.showAreas = function (e, t, n, i, a) { if (!DayPilot.Global.resizing && !DayPilot.Global.moving && !DayPilot.Global.selecting && !e.active && DayPilot.browser.hover) {
            ...
            function r(e, t, n, i) { DayPilot.Menu && DayPilot.Menu.touchPosition(i); var a = n.contextMenu || n.menu; if (a instanceof DayPilot.Menu || (t.isEvent && t.client.contextMenu() ? a = t.client.contextMenu() : t.isEvent && t.calendar.contextMenu && (a = t.calendar.contextMenu)), a && a.show) {
            ...
            i = e; var a = i, o = {}; return o.o = !0, o.p = a.id, o.control = a, o.q = t || {}, o.s = function () { a.hide ? a.hide() : a.nav && a.nav.top ? a.nav.top.style.display = "none" : a.style.display = "none"; }, o.t = function (e) { (function () { return !!a.backendUrl || !("function" != typeof WebForm_DoCallback || !a.uniqueID); })() ? a.commandCallBack && a.commandCallBack("navigate", { "day": e }) : (a.startDate = e, a.update()); }, o.u = function () { n.z(), a.show ? a.show() : a.nav && a.nav.top ? a.nav.top.style.display = "" : a.style.display = ""; }, o.A = function () { if (o.q.navigatorSelectMode)
            return o.q.navigatorSelectMode; if (a.isCalendar)
            switch (a.viewType) {
                case "Day": return "day";
            ...
            switch (a.viewType) {
                ...
                default: return "day";
            } return "day"; }, this.f.push(o), o; }, this.addTrigger = function (e, t) { var i; if ("string" == typeof e) {
            if (i = document.getElementById(e), !i)
                throw "Element not found: " + e;
        }
        else
            i = e; var a = this.B(t); a || (a = this.addView(t)); var o = {}; return o.C = !0, o.D = i, o.p = i.id, o.E = a, o.F = function (e) { n.show(o), n.G(o), e && (e.preventDefault ? e.preventDefault() : e.returnValue = !1); }, DayPilot.re(i, "click", o.F), this.j.push(o), o; }, this.addButton = this.addTrigger, this.select = function (e) { var t = this.H(e); t ? t.F() : this.j.length > 0 && this.j[0].F(); }, this.H = function (e) { for (var t = 0; t < this.j.length; t++) {
            var n = this.j[t];
            if (n.p === e)
                return n;
        } return null; }, this.G = function (e) { if (this.selectedClass) {
        ...
        } }, this.addNavigator = function (e) { n.k.control = e, e.timeRangeSelectedHandling = "JavaScript", e.onTimeRangeSelected = function () { var i, a, o; if (1 === e.api)
            i = arguments[0], a = arguments[1], o = arguments[2];
        else {
            var r = arguments[0];
            i = r.start, a = r.end, o = r.day;
        } n.m = o, t(i, a, o); }; }, this.show = function (e) { var i, a; if (e.C)
            a = e, i = a.E;
        ...
        } this.l = i, i.u(), null !== n.n && i.control.isCalendar && i.control.setScrollY(n.n); var s = i.A(); n.k.updateMode(s), t(n.k.control.selectionStart, n.k.control.selectionEnd.addDays(1), n.k.control.selectionDay); }, this.B = function (e) { for (var t = 0; t < this.f.length; t++)
            if (this.f[t].control === e)
                return this.f[t]; return null; }, this.z = function () { for (var e = 0; e < this.f.length; e++)
            this.f[e].s(); }, Object.defineProperty(this, "active", { get: function () { return n.l; } }), this.events = {}, this.events.load = function (e, t, i) { if (!n.l || !n.l.control)
            throw "DayPilot.Switcher.events.load(): Active view not found"; n.l.control.events.load(e, t, i); }, this.I = null, this.J = function () { if (e)
            for (var t in e)
                if ("triggers" === t) {
                    var i = e.triggers || [];
        ...
        DayPilot.Date.today = function () { return new DayPilot.Date(DayPilot.DateUtil.localToday(), !0); }, DayPilot.Date.now = function () { return new DayPilot.Date; }, DayPilot.Date.fromYearMonthDay = function (e, t, n) { t = t || 1, n = n || 1; var i = new Date(0); return i.setUTCFullYear(e), i.setUTCMonth(t - 1), i.setUTCDate(n), new DayPilot.Date(i); }, DayPilot.DateUtil = {}, DayPilot.DateUtil.fromStringSortable = function (e, t) { if (!e)
            throw "Can't create DayPilot.Date from an empty string"; var n = e.length, i = 10 === n, a = 19 === n, o = n > 19; if (!i && !a && !o)
            throw "Invalid string format (use '2010-01-01' or '2010-01-01T00:00:00'): " + e; if (DayPilot.Date.Cache.Parsing[e] && !t)
            return DayPilot.Stats.cacheHitsParsing += 1, DayPilot.Date.Cache.Parsing[e]; var r = e.substring(0, 4), s = e.substring(5, 7), l = e.substring(8, 10), d = new Date(0); if (d.setUTCFullYear(r, s - 1, l), i)
            return DayPilot.Date.Cache.Parsing[e] = d, d; var c = e.substring(11, 13), u = e.substring(14, 16), h = e.substring(17, 19); if (d.setUTCHours(c), d.setUTCMinutes(u), d.setUTCSeconds(h), a)
            return DayPilot.Date.Cache.Parsing[e] = d, d; var f = e[19], v = 0; if ("." === f) {
            var p = parseInt(e.substring(20, 23));
            d.setUTCMilliseconds(p), v = DayPilot.DateUtil.getTzOffsetMinutes(e.substring(23));
        }
        else
            v = DayPilot.DateUtil.getTzOffsetMinutes(e.substring(19)); var m = new DayPilot.Date(d); return t || (m = m.addMinutes(-v)), d = m.toDate(), DayPilot.Date.Cache.Parsing[e] = d, d; }, DayPilot.DateUtil.getTzOffsetMinutes = function (e) { if (DayPilot.Util.isNullOrUndefined(e) || "" === e)
            return 0; if ("Z" === e)
            return 0; var t = e[0], n = parseInt(e.substring(1, 3)), i = parseInt(e.substring(4)), a = 60 * n + i; if ("-" === t)
            return -a; if ("+" === t)
            return a; throw "Invalid timezone spec: " + e; }, DayPilot.DateUtil.hasTzSpec = function (e) { return !!e.indexOf("+") || !!e.indexOf("-"); }, DayPilot.DateUtil.daysDiff = function (e, t) { if (e && t || function () { throw "two parameters required"; }(), e = new DayPilot.Date(e), t = new DayPilot.Date(t), e.getTime() > t.getTime())
            return null; for (var n = 0, i = e.getDatePart(), a = t.getDatePart(); i < a;)
            i = i.addDays(1), n++; return n; }, DayPilot.DateUtil.daysSpan = function (e, t) { if (e && t || function () { throw "two parameters required"; }(), e = new DayPilot.Date(e), t = new DayPilot.Date(t), e.getTime() === t.getTime())
            return 0; var n = DayPilot.DateUtil.daysDiff(e, t); return t.getTime() == t.getDatePart().getTime() && n--, n; }, DayPilot.DateUtil.diff = function (e, t) { if (!(e && t && e.getTime && t.getTime))
        ...
        var a = function (e, n) { "string" == typeof n && (n = DayPilot.Locale.find(n)); var n = n || DayPilot.Locale.US, i = [{ "seq": "yyyy", "expr": "[0-9]{4,4}", "str": function (e) { return e.getYear(); } }, { "seq": "yy", "expr": "[0-9]{2,2}", "str": function (e) { return e.getYear() % 100; } }, { "seq": "mm", "expr": "[0-9]{2,2}", "str": function (e) { var t = e.getMinutes(); return t < 10 ? "0" + t : t; } }, { "seq": "m", "expr": "[0-9]{1,2}", "str": function (e) { return e.getMinutes(); } }, { "seq": "HH", "expr": "[0-9]{2,2}", "str": function (e) { var t = e.getHours(); return t < 10 ? "0" + t : t; } }, { "seq": "H", "expr": "[0-9]{1,2}", "str": function (e) { return e.getHours(); } }, { "seq": "hh", "expr": "[0-9]{2,2}", "str": function (e) { var t = e.getHours(), t = t % 12; 0 === t && (t = 12); var n = t; return n < 10 ? "0" + n : n; } }, { "seq": "h", "expr": "[0-9]{1,2}", "str": function (e) { var t = e.getHours(), t = t % 12; return 0 === t && (t = 12), t; } }, { "seq": "ss", "expr": "[0-9]{2,2}", "str": function (e) { var t = e.getSeconds(); return t < 10 ? "0" + t : t; } }, { "seq": "s", "expr": "[0-9]{1,2}", "str": function (e) { return e.getSeconds(); } }, { "seq": "MMMM", "expr": "[^\\s0-9]*", "str": function (e) { return n.monthNames[e.getMonth()]; }, "transform": function (e) { var i = DayPilot.indexOf(n.monthNames, e, t); return i < 0 ? null : i + 1; } }, { "seq": "MMM", "expr": "[^\\s0-9]*", "str": function (e) { return n.monthNamesShort[e.getMonth()]; }, "transform": function (e) { var i = DayPilot.indexOf(n.monthNamesShort, e, t); return i < 0 ? null : i + 1; } }, { "seq": "MM", "expr": "[0-9]{2,2}", "str": function (e) { var t = e.getMonth() + 1; return t < 10 ? "0" + t : t; } }, { "seq": "M", "expr": "[0-9]{1,2}", "str": function (e) { return e.getMonth() + 1; } }, { "seq": "dddd", "expr": "[^\\s0-9]*", "str": function (e) { return n.dayNames[e.getDayOfWeek()]; } }, { "seq": "ddd", "expr": "[^\\s0-9]*", "str": function (e) { return n.dayNamesShort[e.getDayOfWeek()]; } }, { "seq": "dd", "expr": "[0-9]{2,2}", "str": function (e) { var t = e.getDay(); return t < 10 ? "0" + t : t; } }, { "seq": "%d", "expr": "[0-9]{1,2}", "str": function (e) { return e.getDay(); } }, { "seq": "d", "expr": "[0-9]{1,2}", "str": function (e) { return e.getDay(); } }, { "seq": "tt", "expr": "(AM|PM|am|pm)", "str": function (e) { return e.getHours() < 12 ? "AM" : "PM"; }, "transform": function (e) { return e.toUpperCase(); } }], a = function (e) { return e.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"); }; this.init = function () { this.year = this.findSequence("yyyy"), this.month = this.findSequence("MMMM") || this.findSequence("MMM") || this.findSequence("MM") || this.findSequence("M"), this.day = this.findSequence("dd") || this.findSequence("d"), this.hours = this.findSequence("HH") || this.findSequence("H"), this.minutes = this.findSequence("mm") || this.findSequence("m"), this.seconds = this.findSequence("ss") || this.findSequence("s"), this.ampm = this.findSequence("tt"), this.hours12 = this.findSequence("hh") || this.findSequence("h"); }, this.findSequence = function (t) { function n(e) { return parseInt(e); } return e.indexOf(t) === -1 ? null : { "findValue": function (o) { for (var r = a(e), s = null, l = 0; l < i.length; l++) {
            ...
            if (i[t] && i[t].seq === e)
                return i[t]; return null; }, a = e.length <= 0, o = 0, r = []; !a;) {
        ...
        } return r.join(""); }, this.parse = function (e) { var t = this.year.findValue(e); if (!t)
        ...
        DayPilot.ColorUtil = {}, DayPilot.ColorUtil.hexToRgb = function (e) { if (!/^#[0-9a-f]{6}$/i.test(e))
            ...
            return t && t.internal.adjustEndIn ? t.internal.adjustEndIn(new DayPilot.Date(i.data.end)) : new DayPilot.Date(i.data.end); throw new DayPilot.Exception("DayPilot.Event.rawend() is readonly"); }, this.partStart = function () { return new DayPilot.Date(this.part.start); }, this.partEnd = function () { return new DayPilot.Date(this.part.end); }, this.tag = function (e) { var t = i.data.tag; if (!t)
            return null; if ("undefined" == typeof e)
            return i.data.tag; for (var n = i.calendar.tagFields, a = -1, o = 0; o < n.length; o++)
            e === n[o] && (a = o); if (a === -1)
...
if ("undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function () {
    ...
    if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
        ...
        t.selectedCells = [], t.topSelectedCell = null, t.bottomSelectedCell = null, t.column = null, t.firstSelected = null, t.firstMousePos = null, t.originalMouse = null, t.originalHeight = null, t.originalTop = null, t.resizing = null, t.globalHandlers = !1, t.moving = null, t.register = function (e) { t.registered || (t.registered = []); for (var n = t.registered, i = 0; i < n.length; i++)
            ...
            t.selecting = !1; }, t.deleteShadow = function (e) { e && e.parentNode && e.parentNode.removeChild(e); }, t.moveShadow = function (e) { var n = t.movingShadow, i = n.parentNode; i.style.display = "none", n.parentNode.removeChild(n), e.firstChild.appendChild(n), n.style.left = "0px", i.style.display = "", n.style.width = t.movingShadow.parentNode.offsetWidth + 1 + "px"; };
        ...
        t.Calendar = function (e, a) {
            ...
            } return r.weekStarts || 0; }, this.ca.fa = function () { var e = r.cellDuration; if (e <= 1)
                return 1; if (e >= 60)
            ...
            this.W = function (e, t) {
            ...
            } return "function" == typeof r.onEventRightClicked && r.onEventRightClicked(n), e.preventDefault && e.preventDefault(), !1; }, this.eventDeleteCallBack = function (e, t) { this.U("EventDelete", t, e); }, this.eventDeletePostBack = function (e, t) { this.S("EventDelete", t, e); }, this.ya = function (e) { if (r.ta()) {
                var t = {};
                ...
                } }, this.eventResizeCallBack = function (e, t, n, i) { if (!t)
                ...
                } }, this.timeRangeSelectedPostBack = function (e, t, n, i) { var a = {}; a.start = e, a.end = t, this.S("TimeRangeSelected", i, a); }, this.timeRangeSelectedCallBack = function (e, t, n, i) { var a = {}; a.start = e, a.end = t, this.U("TimeRangeSelected", i, a); }, this.O = function (e, t, n) { if (e = new DayPilot.Date(e), t = new DayPilot.Date(t), this.ta()) {
                var i = {};
            ...
            } var n = []; return n.lines = [], n.events = [], n.overlapsWith = function (e, t) { return !(e + t - 1 < this.min || e > this.max - 1); }, n.putIntoLine = function (e) { for (var t = 0; t < this.lines.length; t++) {
                var n = this.lines[t];
                if (n.isFree(e.part.top, e.part.height))
                    return n.push(e), t;
            } var n = []; return n.isFree = function (e, t) { for (var n = e + t - 1, i = this.length, a = 0; a < i; a++) {
                var o = this[a];
                if (!(n < o.part.top || e > o.part.top + o.part.height - 1))
                    return !1;
            } return !0; }, n.push(e), this.lines.push(n), this.lines.length - 1; }, n.events.push(e), n.min = e.part.top, n.max = e.part.top + e.part.height, this.blocks.push(n), this.blocks.length - 1; }, t.putIntoLine = function (e) { for (var t = 0; t < this.lines.length; t++) {
                var n = this.lines[t];
                if (n.isFree(e.part.top, e.part.height))
                    return n.push(e), t;
            } var n = []; return n.isFree = function (e, t) { for (var n = e + t - 1, i = this.length, a = 0; a < i; a++) {
            ...
            } }, s.onmousedown = function (n) { var i = n.which || n.button; if ("n-resize" !== this.style.cursor && "s-resize" !== this.style.cursor || 1 !== i) {
            ...
            } var p = i.areas ? DayPilot.Areas.copy(i.areas) : []; if (DayPilot.Areas.attach(s, e, { "areas": p }), "function" == typeof r.onAfterEventRender) {
                var m = {};
            ...
            } return null; }, this.events.forRange = function (e, t) { return e = new DayPilot.Date(e), t = new DayPilot.Date(t), (r.events.list || []).filter(function (n) { return i(e, t, new DayPilot.Date(n.start), new DayPilot.Date(n.end)); }).map(function (e) { return new DayPilot.Event(e, r); }); }, this.events.update = function (e) { if (e instanceof DayPilot.Event)
                e.commit();
            ...
            for (name in e)
                n[name] = e[name];
            n.init(), t || (t = n);
        } }); return 1 === this.length ? t : n; }; }(jQuery), function () { var e = DayPilot.am(); e && e.directive("daypilotCalendar", ["$parse", function (e) { return { "restrict": "E", "template": "<div></div>", "replace": !0, "link": function (t, n, i) { var a = new DayPilot.Calendar(n[0]); a.wa.scope = t, a.init(); var o = i["id"]; o && (t[o] = a); var r = i["publishAs"]; if (r) {
                    (0, e(r).assign)(t, a);
                } for (var s in i)
...
if ("undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function (DayPilot) {
                        ...
                        if (p.style.position = "relative", p.style.display = "block", h.cssClass && DayPilot.Util.addClass(p, h.cssClass), h.disabled)
                            ...
                            if (h.onclick)
                                ...
                                var g = function (e, t) { return function (n) { var i = t.source, a = e; a.action = a.action ? a.action : "CallBack"; var o = i.calendar || i.root; if (i instanceof DayPilot.Link)
                                    ...
                                    return void o.internal.timeRangeMenuClick(a.command, i, a.action); if (i instanceof DayPilot.Task)
                                    return void ("resource" === i.menuType ? o.internal.resourceHeaderMenuClick(a.command, t.menuSource, a.action) : o.internal.eventMenuClick(a.command, t.menuSource, a.action)); switch (i.menuType) {
    ...
    function e(t, n, i) { var a = n.indexOf("."); if (a === -1)
        return void ("__proto__" !== n && "constructor" !== n && (t[n] = i)); var o = n.substring(0, a); if ("__proto__" !== o && "constructor" !== o) {
    ...
    if (!DayPilot.ModalStatic) {
        ...
        DayPilot.Modal.form = function (t, n, i) { if (1 === arguments.length) {
            ...
            for (var o in t.result)
                e(a, o, t.result[o]);
            t.result = a;
        } i(t); }; var o = new DayPilot.Modal(d), s = document.createElement("div"); s.className = o.theme + "_inner"; var l = document.createElement("div"); l.className = o.theme + "_input"; var h = new r({ theme: o.theme, form: t, data: n, zIndex: o.zIndex, locale: o.locale, plugins: o.plugins, onKey: function (e) { switch (e.key) {
                case "Enter":
        ...
        r.prototype.create = function () { return this.load(), this.render(), this.Ec; }, r.prototype.render = function () { var e = this; this.Ec = document.createElement("div"), this.Bc.forEach(function (t) { e.createView(t); }), this.applyState(); }, r.prototype.createView = function (e) { var t = this.theme, n = this, i = document.createElement("div"); if (i.className = t + "_form_item " + t + "_form_item_level" + e.level, e.interactive || "title" !== e.type ? i.className += " " + t + "_form_item_" + e.type : i.className += " " + t + "_form_title", e.data.cssClass && (i.className += " " + e.data.cssClass), !e.isValue) {
            ...
            if (c.valid)
                ...
                if (i) {
                    ...
                    n();
            r = c.valid;
        } return r; }, r.prototype.load = function () { var e = this; this.form.forEach(function (t) { e.processFormItem(t, 0); }); var n; try {
    ...
    if ("undefined" == typeof DayPilot.Month || !DayPilot.Month.events) {
        ...
        e.Month = function (n, i) {
            ...
            this.id = n, this.isMonth = !0, this.api = 2, this.backendUrl = null, this.cellHeaderHeight = 24, this.cellHeight = 100, this.cellMarginBottom = 0, this.contextMenu = null, this.cssClassPrefix = "month_default", this.eventBarVisible = !0, this.eventBorderRadius = null, this.eventHeight = 25, this.eventsLoadMethod = "GET", this.headerHeight = 30, this.hideUntilInit = !0, this.lineSpace = 1, this.locale = "en-us", this.showToolTip = !0, this.startDate = new DayPilot.Date, this.theme = null, this.visible = !0, this.weekStarts = "Auto", this.width = "100%", this.xssProtection = "Enabled", this.afterRender = function () { }, this.cellHeaderClickHandling = "Enabled", this.eventClickHandling = "Enabled", this.eventDeleteHandling = "Disabled", this.eventMoveHandling = "Update", this.eventResizeHandling = "Update", this.eventRightClickHandling = "ContextMenu", this.headerClickHandling = "Enabled", this.timeRangeSelectedHandling = "Enabled", this.onCellHeaderClick = null, this.onCellHeaderClicked = null, this.onEventClick = null, this.onEventClicked = null, this.onEventDelete = null, this.onEventDeleted = null, this.onEventMove = null, this.onEventMoved = null, this.onEventResize = null, this.onEventResized = null, this.onEventRightClick = null, this.onEventRightClicked = null, this.onTimeRangeSelect = null, this.onTimeRangeSelected = null, this.onBeforeEventRender = null, this.onBeforeCellRender = null, this.cellEvents = [], this.elements = {}, this.elements.events = [], this.cache = {}, this.Q = !1, this.W = function (e, t) { var e = JSON.parse(e); return e.CallBackRedirect ? void (document.location.href = e.CallBackRedirect) : "None" === e.UpdateType ? void a.fireAfterRenderDetached(e.CallBackData, !0) : (a.events.list = e.Events, "Full" === e.UpdateType && (a.startDate = e.StartDate, a.timeFormat = e.TimeFormat ? e.TimeFormat : a.timeFormat, "undefined" != typeof e.WeekStarts && (a.weekStarts = e.WeekStarts), a.hashes = e.Hashes), a.Y(), a.ed(), a.ha(), "Full" === e.UpdateType && (a.fd(), a.gd()), a.ma(), a.show(), a.na(), void a.fireAfterRenderDetached(e.CallBackData, !0)); }, this.fireAfterRenderDetached = function (e, t) { var n = function (e, t) { return function () { a.afterRender && a.afterRender(e, t); }; }; window.setTimeout(n(e, t), 0); }, this.lineHeight = function () { return this.eventHeight + this.lineSpace; }, this.events = {}, this.events.add = function (e) { var t = null; if (e instanceof DayPilot.Event)
                ...
                t = e;
            } a.events.list || (a.events.list = []), a.events.list.push(t), a.update(), a.wa.notify(); }, this.events.find = function (e) { if (!a.events.list)
                return null; if ("function" == typeof e) {
            ...
            } a.update(), a.wa.notify(); }, this.events.remove = function (e) { var t; if (e instanceof DayPilot.Event)
                t = e.data;
            else if ("object" == typeof e) {
                ...
                n && (t = n.data);
            } var i = DayPilot.indexOf(a.events.list, t); a.events.list.splice(i, 1), a.update(), a.wa.notify(); }, this.events.load = function (e, t, n) { var i = function (e) { var t = {}; t.exception = e.exception, t.request = e.request, "function" == typeof n && n(t); }, o = function (e) { var n, o = e.request; try {
            ...
            } t[e] = i; }, this.ha = function () { var e = this.events.list; if (e) {
                if (!DayPilot.isArray(e))
                ...
                } var r = []; return r.isFree = function (e, t) { for (var n = !0, i = 0; i < this.length; i++)
            ...
            } }; }, this.ma = function () { this.nav.top.style.height = this.getHeight() + "px"; for (var e = 0; e < this.cells.length; e++)
                for (var t = 0; t < this.cells[e].length; t++)
                    this.cells[e][t].style.top = this.getRowTop(t) + "px", this.cells[e][t].style.height = this.rows[t].getHeight() + "px"; }, this.getCellBelowPoint = function (e, t) { for (var n = Math.floor(this.nav.top.clientWidth / this.getColCount()), i = Math.min(Math.floor(e / n), this.getColCount() - 1), a = null, o = this.headerHeight, r = 0, s = 0; s < this.rows.length; s++) {
                var l = o;
                ...
                } }, this.eventDeleteCallBack = function (e, t) { this.U("EventDelete", t, e); }, this.eventDeletePostBack = function (e, t) { this.S("EventDelete", t, e); }, this.eventMoveCallBack = function (e, t, n, i, a) { if (!t)
                throw "newStart is null"; if (!n)
                throw "newEnd is null"; var o = {}; o.e = e, o.newStart = t, o.newEnd = n, o.position = a, this.U("EventMove", i, o); }, this.M = function (e, t, n, i, o, r) { var s = e.start().getTimePart(), l = e.end().getDatePart(); l.getTime() !== e.end().getTime() && (l = l.addDays(1)); var d = DayPilot.DateUtil.diff(e.end(), l), c = this.getDateFromCell(t, n); c = c.addDays(-i); var u = DayPilot.DateUtil.daysSpan(e.start(), e.end()) + 1, h = c.addDays(u), f = c.addTime(s), v = h.addTime(d); if (a.ta()) {
                var p = {};
                ...
                throw "newStart is null"; if (!n)
                throw "newEnd is null"; var a = {}; a.e = e, a.newStart = t, a.newEnd = n, this.U("EventResize", i, a); }, this.K = function (e, t, n) { var i = e.start().getTimePart(), o = e.end().getDatePart(); o.getTime() !== e.end().getTime() && (o = o.addDays(1)); var r = DayPilot.DateUtil.diff(e.end(), o), s = this.getDateFromCell(t.x, t.y), l = s.addDays(n), d = s.addTime(i), c = l.addTime(r); if (a.ta()) {
                var u = {};
                ...
                } }, this.timeRangeSelectedCallBack = function (e, t, n) { var i = {}; i.start = e, i.end = t, this.U("TimeRangeSelected", n, i); }, this.O = function (e, t) { if (this.ta()) {
                var n = {};
            ...
            for (name in e)
                n[name] = e[name];
            n.Init(), t || (t = n);
        } }); return 1 === this.length ? t : n; }; }(jQuery), function () { var e = DayPilot.am(); e && e.directive("daypilotMonth", ["$parse", function (e) { return { "restrict": "E", "template": "<div></div>", "replace": !0, "link": function (t, n, i) { var a = new DayPilot.Month(n[0]); a.wa.scope = t, a.init(); var o = i["id"]; o && (t[o] = a); var r = i["publishAs"]; if (r) {
                    (0, e(r).assign)(t, a);
                } for (var s in i)
                    0 === s.indexOf("on") && !function (n) { a[n] = function (a) { var o = e(i[n]); t["$apply"](function () { o(t, { "args": a }); }); }; }(s); var l = t["$watch"], d = i["config"] || i["daypilotConfig"], c = i["events"] || i["daypilotEvents"]; l.call(t, d, function (e) { for (var t in e)
                    a[t] = e[t]; a.update(); }, !0), l.call(t, c, function (e) { a.events.list = e, a.update(); }, !0); } }; }]); }(), "undefined" != typeof Sys && Sys.Application && Sys.Application.notifyScriptLoaded && Sys.Application.notifyScriptLoaded();
    }
}(), "undefined" == typeof DayPilot)
    var DayPilot = {};
if ("undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function (DayPilot) {
    ...
    if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.def) {
        ...
        DayPilot.Navigator = function (t, n) {
            ...
            a.start = null, a.drawCell = function (e) { var t = i.months[e.month], n = i.Bd(e.x, e.y), o = t.top + n.y, s = t.left + n.x, l = "px", d = i.vd(); if (r.od()) {
                ...
                a.cells = [];
            } }, a.draw = function () { var e = a.ordered(), t = new o(e.start), n = e.end; if (n) {
    ...
    if ("undefined" == typeof DayPilot.Scheduler) {
        ...
        DayPilot.Scheduler = function (a, s) {
            ...
            c.timeout = null, c.options = null, c.enabled = !1, c.request = function (e) { c.enabled ? (clearTimeout(c.timeout), c.jf(e), c.timeout = setTimeout(c.doit)) : (c.jf(e), c.doit()); }, c.jf = function (e) { if (e) {
                ...
                e.push(n);
            } return e; }, this.events.forRange = function (e, t) { e = e ? new DayPilot.Date(e) : l.visibleStart(), t = t ? new DayPilot.Date(t) : l.visibleEnd(); for (var n = [], i = 0; i < l.events.list.length; i++) {
                var a = new DayPilot.Event(l.events.list[i], l);
            ...
            } return !0; }, e; }, t.findFreeLine = function (e, n) { for (var i = 0; i < this.lines.length; i++) {
                var a = this.lines[i];
                if (a.isFree(e, n))
                    return i;
