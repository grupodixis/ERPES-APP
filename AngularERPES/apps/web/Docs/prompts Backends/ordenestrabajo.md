# OrdenesTrabajo — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar OrdenesTrabajo aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de OrdenesTrabajo
- [ ] Estados y aprobaciones.
- [ ] Código único.
- [ ] Relación con Partida/Obra.

---

## 2) Endpoints propuestos
- `CRUD /ordenes-trabajo`
- `POST /ordenes-trabajo/{id}/aprobar`
