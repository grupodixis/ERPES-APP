# Partidas — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Partidas aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de Partidas
- [ ] Vínculo opcional a Producto para explosionar BOM.

---

## 2) Endpoints propuestos
- `GET/POST /capitulos/{id}/partidas`
- `CRUD /partidas/{id}`
