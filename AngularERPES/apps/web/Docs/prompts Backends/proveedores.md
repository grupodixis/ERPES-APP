# Proveedores — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Proveedores aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
- [ ] **Datos iniciales**: Crea un buen Seed con datos de proveedores.

---

## 1) Especificidades de Proveedores
- [ ] Validaciones IBAN/SWIFT opcionales.
- [ ] Email de facturas.
