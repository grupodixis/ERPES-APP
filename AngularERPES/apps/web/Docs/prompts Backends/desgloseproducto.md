# DesgloseProducto — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar DesgloseProducto aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de DesgloseProducto
- [ ] **Un recurso exacto por línea** (`Articulo`/`CategoriaOperario`/`TipoMaquinaria`/`Subcontrata`).
- [ ] `FactorPorUMVenta > 0`.

---

## 2) Endpoints propuestos
- `GET /productos/{id}/desglose`
- `POST /productos/{id}/desglose`
- `CRUD /desglose-producto/{id}`
