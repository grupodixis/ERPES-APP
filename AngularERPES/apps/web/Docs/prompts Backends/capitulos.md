# Capitulos — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Capitulos aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de Capitulos
