# Operarios — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Operarios aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de Operarios
- [ ] Coste hora base, NSS, datos corporativos.

---

## 2) Endpoints propuestos
- `CRUD /operarios`
- `GET /operarios/activos`
