# FormasPago — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar FormasPago aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de FormasPago
- [ ] Catálogo simple con nombre único.
