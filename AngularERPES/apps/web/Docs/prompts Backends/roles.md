# Roles — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Roles aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de Roles
- [ ] Roles por empresa. `(IdEmpresa, Nombre) UNIQUE`.
