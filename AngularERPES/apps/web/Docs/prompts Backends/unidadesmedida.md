# UnidadesMedida — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar UnidadesMedida aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de UnidadesMedida
- [ ] **Una UM base por magnitud** (índice filtrado/validación).
- [ ] Helper de conversión.

---

## 2) Endpoints propuestos
- `CRUD /unidades-medida`
- `GET /unidades-medida/magnitud/{m}`
