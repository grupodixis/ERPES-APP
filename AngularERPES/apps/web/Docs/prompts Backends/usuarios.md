# Usuarios — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Usuarios aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
