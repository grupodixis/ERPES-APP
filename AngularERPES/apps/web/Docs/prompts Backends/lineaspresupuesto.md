# LineasPresupuesto — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar LineasPresupuesto aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de LineasPresupuesto
- [ ] **Snapshot thin** con traza `IdDesglose` y datos materializados.
- [ ] Recalcular totales.

---

## 2) Endpoints propuestos
- `GET/POST /versiones-presupuesto/{id}/lineas`
- `CRUD /lineas-presupuesto/{id}`
- `POST /lineas-presupuesto/{id}/recalcular`
