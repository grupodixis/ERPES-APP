# RolesPermisos — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar RolesPermisos aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de RolesPermisos
- [ ] Alta/baja de asignaciones rol↔permiso.

---

## 2) Endpoints propuestos
- `GET /roles/{id}/permisos`
- `POST /roles/{id}/permisos/{idPermiso}`
- `DELETE /roles/{id}/permisos/{idPermiso}`
