# Articulos — Prompt para Cursor (NestJS API)

> **Objetivo:** Implementar Articulos aplicando arquitectura hexagonal en NestJS, con TypeORM y Angular Admin.
...
## 1) Especificidades de Articulos
- [ ] Materiales/subcontratas como artículo.
- [ ] `IdUMStock` requerido.
